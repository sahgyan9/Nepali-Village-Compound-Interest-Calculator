        ...
        {!isWizardOpen ? (
          <div className="flex flex-col mb-12">
            <div className="flex justify-center mb-8">
              <button
                onClick={startWizard}
                className="btn-glow w-full md:w-auto flex items-center justify-center py-5 px-10 border border-transparent rounded-2xl shadow-xl text-xl font-bold text-white bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-blue-500 transition-all transform hover:scale-[1.03] active:scale-[0.97]"
              >
                ...
                {language === 'en' ? 'Step-by-Step Guide' : 'नयाँ गणना (सजिलो तरिका)'}
              </button>
            </div>
            ...
            <div className="relative flex py-5 items-center">
                ...
                <span className="flex-shrink-0 mx-4 text-gray-400 dark:text-gray-500 text-sm">
                  {language === 'en' ? 'Or use the full form below' : 'वा तलको पूरा फारम प्रयोग गर्नुहोस्'}
                </span>
                <div className="flex-grow border-t border-gray-200 dark:border-slate-700"></div>
            </div>

            <form onSubmit={(e) => { e.preventDefault(); calculateInterest(); }} className="space-y-6 mt-4">
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    placeholder="0"
                    aria-describedby="principal-currency-inline"
                  />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    <span className="text-gray-500 dark:text-gray-400 sm:text-sm" id="principal-currency-inline">{t.npr}</span>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    min="0"
                    step="any"
                    aria-describedby="interest-rate-unit-inline"
                  />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    <span className="text-gray-500 dark:text-gray-400 sm:text-sm" id="interest-rate-unit-inline">%</span>
                  </div>
                </div>
                <div className="mt-2 flex flex-wrap items-center gap-2">
